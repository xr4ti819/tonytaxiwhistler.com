...
export const ACTIVITIES = [
  ...
  { name: "Dog Sledding · Callaghan", price: "$189/adult", badge: "Iconic Winter", img: "https://images.unsplash.com/photo-1647591413270-469a0393da0c?w=800&q=80", shuttle: "$55", category: "Winter" },
  { name: "Snowmobile Tours", price: "$199/2-hr", badge: "Backcountry", img: "https://images.unsplash.com/photo-1549351245-ac6dda50eb92?w=800&q=80", shuttle: "$55", category: "Winter" },
  { name: "Ziplining · Ziptrek Ecotours", price: "$169/adult", badge: "All Year", img: "https://images.unsplash.com/photo-1637511077877-3c6a00eb32ba?w=800&q=80", shuttle: "$25", category: "Adventure" },
];
...
export const SHOPS = [
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1645397925470-ccb7d7605402?w=800&q=80",
    tag: "Cannabis",
    hoursLabel: "9AM–12AM",
    hours: {
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1615915468538-0fbd857888ca?w=800&q=80",
    tag: "Vape Lounge",
    hoursLabel: "11AM–11PM",
    hours: {
...
export const NIGHTLIFE = [
  ...
  { name: "Roxy's · Whistler", type: "Late-Night Bar & Dance", hours: "9PM–2AM", desc: "Iconic Whistler dance bar · Live DJs · Themed nights · Late kitchen · Easily the loudest spot in the village", img: "https://images.unsplash.com/photo-1568849676085-51415703900f?w=800&q=80", happy_hour: "9–11 PM · $5 highballs · $6 shots · $7 wings" },
...
export const LIQUOR_STORES = [
  {
    name: "BC Liquor Store · Whistler Village",
    desc: "Government store · widest selection in Whistler · BC wines, craft beer, spirits, ciders. Knowledgeable staff. ID 19+ required.",
    address: "4360 Lorimer Rd, Whistler",
    phone: "604-932-5331",
    hours: {
      "Mon": "9:30 AM – 11:00 PM",
      "Tue": "9:30 AM – 11:00 PM",
      "Wed": "9:30 AM – 11:00 PM",
      "Thu": "9:30 AM – 11:00 PM",
      "Fri": "9:30 AM – 11:00 PM",
      "Sat": "9:30 AM – 11:00 PM",
      "Sun": "11:00 AM – 9:00 PM",
    },
    tag: "Government · Largest Selection",
    img: "https://images.unsplash.com/photo-1569529465841-dfecdab7503b?w=800&q=80",
    shuttle: "$15",
    link: "https://www.bcliquorstores.com/store/172",
  },
  {
    name: "21 Steps Liquor Store",
    desc: "Private liquor store · curated craft beer · BC wines · imported spirits · cigars. Quick stop opposite 21 Steps Kitchen+Bar.",
    address: "4433 Sundial Pl, Whistler",
    phone: "604-966-2121",
    hours: {
      "Mon": "10:00 AM – 11:00 PM",
      "Tue": "10:00 AM – 11:00 PM",
    ...
    tag: "Private · Craft & Imports",
    img: "https://images.unsplash.com/photo-1543007630-9710e4a00a20?w=800&q=80",
    shuttle: "$15",
  },
  {
    name: "Whistler Village Liquor Store",
    desc: "Private retailer in the heart of Whistler Village · cold beer, ready-to-drink cocktails, party kegs on order, ice & mixers.",
    ...
    tag: "Private · Village Centre",
    img: "https://images.unsplash.com/photo-1532634922-8fe0b757fb13?w=800&q=80",
    shuttle: "$15",
  },
  {
    name: "Nesters Liquor Store",
    desc: "Private liquor store inside Nesters Market complex · convenient for Nesters / Spruce Grove locals. Cold beer & wine.",
    address: "7019 Nesters Rd, Whistler",
    phone: "604-932-3545",
    hours: {
      "Mon": "10:00 AM – 11:00 PM",
      "Tue": "10:00 AM – 11:00 PM",
    ...
    tag: "Private · North Whistler",
    img: "https://images.unsplash.com/photo-1568849676085-51415703900f?w=800&q=80",
    shuttle: "$15",
  },
  {
    name: "Creekside Liquor Store",
    desc: "Cold beer · BC wines · spirits · ready-to-drink cans. Quick stop in Creekside before hitting the chairs or après-ski.",
    address: "2071 Lake Placid Rd, Whistler",
    phone: "604-938-9463",
    hours: {
      "Mon": "10:00 AM – 11:00 PM",
      "Tue": "10:00 AM – 11:00 PM",
    ...
    tag: "Private · Creekside",
    img: "https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=800&q=80",
    shuttle: "$25",
  },
  {
    name: "Husky Liquor Store · Function Junction",
    desc: "Functional, fast, family-run · last stop south before the highway. Cold beer & wine · open early & late · grab-and-go.",
    address: "1005 Alpha Lake Rd, Function Junction",
    phone: "604-938-9595",
    hours: {
      "Mon": "9:00 AM – 11:00 PM",
      "Tue": "9:00 AM – 11:00 PM",
